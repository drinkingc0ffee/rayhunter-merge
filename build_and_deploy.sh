#!/bin/bash
# Script to build and deploy the daemon with the new test alert functionality

echo "Building and Deploying Rayhunter Daemon"
echo "======================================"
echo ""
...
echo "$ADB_PATH forward tcp:8080 tcp:8080"
echo ""
