...
# Script to deploy the debug HTML file with map support to the device
...
echo "Copying debug HTML file with map to device..."
adb push debug_sse_minimal_with_map.html /tmp/debug_sse_minimal_with_map.html
adb shell rootshell -c "'cp /tmp/debug_sse_minimal_with_map.html /data/rayhunter/web/debug_sse_minimal_with_map.html'"
adb shell rootshell -c "'chmod 644 /data/rayhunter/web/debug_sse_minimal_with_map.html'"
adb shell rootshell -c "'rm /tmp/debug_sse_minimal_with_map.html'"
